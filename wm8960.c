...
SND_SOC_DAPM_INPUT("RINLINE"),
//SND_SOC_DAPM_INPUT("LINPUT2"),
//SND_SOC_DAPM_INPUT("RINPUT2"),
SND_SOC_DAPM_INPUT("LINMIC"),
SND_SOC_DAPM_INPUT("RINMIC"),
...
SND_SOC_DAPM_MIXER("Left Out Mixer", WM8960_POWER3, 3, 0,
&wm8960_loutput_mixer[0],
ARRAY_SIZE(wm8960_loutput_mixer)),
SND_SOC_DAPM_MIXER("Right Out Mixer", WM8960_POWER3, 2, 0,
...
//{ "Left Speaker PGA", NULL, "Left Out Mixer" },
//{ "Right Speaker PGA", NULL, "Right Out Mixer" },
...
{ "OUT3 VMID", NULL, "Left Out Mixer" },
{ "OUT3 VMID", NULL, "Right Out Mixer" },
};
...
printk("freqOut: %d\n",freq_out);
	...
	if (wm8960->clk_id != WM8960_SYSCLK_PLL) {
		...
		if (i != ARRAY_SIZE(sysclk_divs)) {
			...
			dev_err(component->dev, "failed to configure clockkkkkkkkkkkk\n");
			return -EINVAL;
		}
	}
					...
					unsigned int freq, int dir)
{
	...
	wm8960->freq_in = 11289600;
	//wm8960->sysclk = freq;
	wm8960->sysclk = 11289600;
	wm8960->clk_id = clk_id;

	return 0;
}

#define WM8960_RATES SNDRV_PCM_RATE_8000_44100
			    ...
			    const struct i2c_device_id *id)
{
	...
	regmap_update_bits(wm8960->regmap, WM8960_LINVOL, 0x140, 0x140);
	regmap_update_bits(wm8960->regmap, WM8960_RINVOL, 0x140, 0x140);
	regmap_update_bits(wm8960->regmap, WM8960_LADC, 0x100, 0x100);
	regmap_update_bits(wm8960->regmap, WM8960_RADC, 0x100, 0x100);
	regmap_update_bits(wm8960->regmap, WM8960_LDAC, 0x100, 0x100);
	regmap_update_bits(wm8960->regmap, WM8960_RDAC, 0x100, 0x100);
	regmap_update_bits(wm8960->regmap, WM8960_LOUT1, 0x180, 0x180);
	regmap_update_bits(wm8960->regmap, WM8960_ROUT1, 0x180, 0x180);
	regmap_update_bits(wm8960->regmap, WM8960_LOUT2, 0x100, 0x100);
	regmap_update_bits(wm8960->regmap, WM8960_ROUT2, 0x100, 0x100);

	//regmap_update_bits(wm8960->regmap, WM8960_LOUT1, 0x180, 0x180);
	//regmap_update_bits(wm8960->regmap, WM8960_LOUT2, 0x180, 0x180);
	
	//enable Mono Output
	regmap_update_bits(wm8960->regmap, WM8960_MONOMIX1, 0x80, 0x80);
	regmap_update_bits(wm8960->regmap, WM8960_MONOMIX2, 0x80, 0x80);
	regmap_update_bits(wm8960->regmap, WM8960_POWER2, 0x02, 0x02);

	regmap_update_bits(wm8960->regmap, WM8960_LINPATH, 0x180, 0x180);
