...
#echo "loading ALSAMIXER configs"
#alsactl -d -f ./default.bkp restore  wm8960soundcard

echo "Remove CLK Config"
rm /usr/bin/minimal_clk
rm /etc/init.d/gpclkconfig.sh
update-rc.d -f gpclkconfig.sh remove
